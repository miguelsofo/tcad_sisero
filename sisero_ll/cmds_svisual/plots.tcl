...
set eD_png ../out_svisual/PreDrain_des.tdr_eDensity.png
set eQF_png ../out_svisual/PreDrain_des.tdr_eQF.png
set hD_png ../out_svisual/PreDrain_des.tdr_hDensity.png
set EP_png ../out_svisual/PreDrain_des.tdr_EP.png
set out_csv "../out_svisual/PreDrain_des.tdr.csv"
set dw_png ../out_svisual/PreDrain_des.tdr_dw.png
...
set_field_prop -plot $myplot2D -geom $mydata2D DopingWells -show_bands
zoom_plot -plot $myplot2D -window {-1 10 2.0 15}
export_view $dw_png -plots $myplot2D -format png -overwrite
