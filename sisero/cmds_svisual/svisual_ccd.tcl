...
export_view out_svisual/sisero_ccd.png -plots $myplot2D -format png -overwrite 
...
export_view out_svisual/sisero_ccd_phos.png -plots $myplot2D -format png -overwrite
#
## Boron implant:
...
#
# Phosphorus implant:
set mydata1D [create_cutline -plot $myplot2D -type y -at 2.0]
list_variables -dataset $mydata1D
export_variables {Phosphorus xMoleFraction X} -dataset $mydata1D -filename "out_svisual/ccd_phosphorus.csv" -overwrite
#
