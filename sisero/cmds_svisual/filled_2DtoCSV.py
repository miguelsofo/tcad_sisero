...
# ------------------------------
# Inputs
inTDR='../plts/Filled_des.tdr'
ymin=9.8
ymax=14.8
dy=0.1
# ------------------------------------------------
outCSV='../out_svisual/filled_2D_ElectrostaticPotential.csv'
field2csv(inTDR,'ElectrostaticPotential',outCSV,ymin,ymax,dy)
# ------------------------------------------------
outCSV='../out_svisual/filled_2D_eDensity.csv'
field2csv(inTDR,'eDensity',outCSV,ymin,ymax,dy)
# ------------------------------------------------
outCSV='../out_svisual/filled_2D_hDensity.csv'
